...
module Crime =
    [<Literal>]
    let Sample =
        """[{"category":"anti-social-behaviour","location_type":"Force","location":{"latitude":"51.504888","street":{"id":955002,"name":"On or near Booth Close"},"longitude":"0.115119"},"context":"","outcome_status":null,"persistent_id":"","id":102508605,"location_subtype":"","month":"2022-06"}]"""
